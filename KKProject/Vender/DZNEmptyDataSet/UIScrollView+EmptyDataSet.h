...
/**
 是否需要点击手势，默认需要 Default is YES.

 @param scrollView A scrollView subclass object informing the delegate
 @return NO 不需要
 */
- (BOOL)emptyDataSetNeedTapGesture:(UIScrollView *)scrollView;

/**
 是否需要事件穿透，默认需要 Default is YES.
 
 @param scrollView A scrollView subclass object informing the delegate
 @return NO 不需要
 */
- (BOOL)emptyDataSetNeedHitTest:(UIScrollView *)scrollView;
