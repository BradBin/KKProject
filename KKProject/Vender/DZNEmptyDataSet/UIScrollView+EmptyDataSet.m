...
@property (nonatomic, assign) BOOL isNeedHitTest;
...
- (BOOL)dzn_needTapGesture {
    if (self.emptyDataSetDelegate && [self.emptyDataSetDelegate respondsToSelector:@selector(emptyDataSetNeedTapGesture:)]) {
        return [self.emptyDataSetDelegate emptyDataSetNeedTapGesture:self];
    }
    return YES;
}

- (BOOL)dzn_needHitTest {
    if (self.emptyDataSetDelegate && [self.emptyDataSetDelegate respondsToSelector:@selector(emptyDataSetNeedHitTest:)]) {
        return [self.emptyDataSetDelegate emptyDataSetNeedHitTest:self];
    }
    return YES;
}
