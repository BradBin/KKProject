...
class KKTabBarItemCircleContentView: KKTabBarItemContentView {
    override init(frame: CGRect) {
           super.init(frame: frame)
                  
           self.insets = UIEdgeInsets.init(top: -40, left: 0, bottom: 0, right: 0)
       ...
       override func updateLayout() {
        ...
        self.imageView.layer.cornerRadius = self.frame.size.height * 0.5
